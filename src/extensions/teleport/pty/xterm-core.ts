...
// @ts-expect-error - @xterm/headless has broken ESM exports in Node.js
const Terminal = (xterm.Terminal || (xterm as any).default?.Terminal || xterm) as typeof import("@xterm/headless").Terminal
